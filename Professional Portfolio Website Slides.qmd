---
title: "Quarto Workshop Series: Building a Free Professional Portfolio Website"
...
-   Workshop materials available at <https://github.com/CCIDM/portfolio-website>.
...
# Quick Demo: Quarto Pub Deployment
...
1. **Create a New Quarto Project:**  
   Use RStudio’s project wizard to start a new Quarto project.
...
## Best Practices for GitHub Commits & Pushes {.small}
...
# Configuring Quarto for GitHub Pages

**Deployment Steps:**

1. **Initialize Your Quarto Project:**  
   Include your key pages (index, projects, resume. etc).

2. **Choose a Built-in Theme:**  
   Pick a theme that aligns with your brand (e.g., default, flatly).
...
- Are there any additional features you’d like to explore (e.g., interactive widgets, advanced listings, animations)?
